...
source setup.tcl
#source reads a  file  and  executes  the  commands  in  the  fil(scripts).
...
# it checks if there is a synthesis directory that exists, if not then create the directory and display the message "Creating directory $synthDir"
...
#EXAMPLE : model name	: Intel(R) Core(TM) i7-8700 CPU @ 3.20GHz
#	   cpu MHz : 4420.507
# The IF LOOP, checks for CPU information and if it exists, then return the model of that particular instance. 
#The model refers to  a  MACRO  defined  in  the  LEF library.

puts "Hostname : [info hostname]"
#displays the hostname, 
#OUTPUT: Hostname : cadence02
...
# We set the variable DESIGN and fetch the design name, "scr1_pipe_top"

set GEN_EFF $effort
# We set the variable GEN_EFFORT and fetch the effort level, "low"

set MAP_OPT_EFF $effort
# We set the MAP_OPT_EFF and fetch the mapping optimization effort level, "low"

set DATE [clock format [clock seconds] -format "%b%d-%T"] 
# We set the DATE and get Aug22-12:23:09
...
set _LOG_PATH logs
# We set the variable _LOG_PATH and display logs
...
#OUTPUT: ../technology/45/lib/max/MEM2_4096X32_slow.lib ../technology/45/lib/max/MEM2_2048X32_slow.lib ../technology/45/lib/max/pdkIO.lib ../technology/45/lib/max/MEM2_512X32_slow.lib ../technology/45/lib/max/MEM2_136X32_slow.lib ../technology/45/lib/max/MEM2_128X16_slow.lib ../technology/45/lib/max/MEM2_1024X32_slow.lib ../technology/45/lib/max/MEM1_4096X32_slow.lib ../technology/45/lib/max/MEM1_256X32_slow.lib ../technology/45/lib/max/MEM1_1024X32_slow.lib ../technology/45/lib/max/slow.lib ../technology/45/lib/max/MEM2_128X32_slow.lib ../riscvCoreSyntaCore1/ramInputs/sram_32_1024_max_1p8V_25C.lib ../riscvCoreSyntaCore1/ramInputs/i2c_top.lib ../riscvCoreSyntaCore1/ramInputs/uart.lib
...
#check_timing_intent  checks  the  SDC quality and timing attributes placed on the current design and accordingly issues warnings as needed. These warnings do not indicate design has problems, instead indicate that the SDC has potential errors.
##### OUTPUT 
#Lint summary
